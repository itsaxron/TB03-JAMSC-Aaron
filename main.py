...
# try else function for exception handling
    try:
...
# except Exception for exception handling, will print an error message if there something went wrong running the code
    except Exception:
        print('There was an error when running the code.')
